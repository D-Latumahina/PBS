    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a href="{{ route('notes.index') }}">Abonnementen</a>
            </li>
        ...
        <div class="row">
            <div class="col-xl-8 offset-2">
                <div class="card mx-auto mt-5">
                    <div class="card-header">Abonnement Aanpassen</div>
                    <div class="card-body">
                        <form action="{{ route('notes.update') }}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <label for="note_title">Abonnement</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <label for="note_amount">Kosten</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <label for="note_date">Incasso Datum</label>
                                </div>
                            </div>
                            <div class="float-right">
                                <a href="{{ route('notes.index') }}" class="btn btn-success">Terug</a>
