    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a href="{{ route('incomes.index') }}">Inkomen</a>
            </li>
        ...
        <div class="row">
            <div class="col-xl-8 offset-2">
                <div class="card mx-auto mt-5">
                    <div class="card-header">Inkomen Aanpassen</div>
                    <div class="card-body">
                        <form action="{{ route('incomes.update') }}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <label for="income_title">Bron Inkomen</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <label for="income_amount">Hoeveelheid Inkomen</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <label for="income_date">Datum Inkomen</label>
                                </div>
                            </div>
                            <div class="float-right">
                                <a href="{{ route('incomes.index') }}" class="btn btn-success">Terug</a>
