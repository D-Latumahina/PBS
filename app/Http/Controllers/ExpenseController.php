...
class ExpenseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/expense')->with('message', 'Nieuwe Uitgaven Toegevoegd');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/expense')->with('message', 'Uitgaven Zijn Succesvol Aangepast');
    }

    public function destroy($id)
    {
        Expense::findOrFail($id)->delete();
        return back()->with('message', 'Uitgaven Zijn Succesvol Verwijdert');
    }
}
