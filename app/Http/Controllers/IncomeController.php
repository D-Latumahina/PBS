...
class IncomeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/incomes')->with('message', 'Nieuw Inkomen Toegevoegd');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/incomes')->with('message', 'Inkomen Succesvol Aangepast');
    }

    public function destroy($id)
    {
        Income::findOrFail($id)->delete();
        return redirect('/incomes')->with('success', 'Inkomen Succesvol Verwijderd');
    }
}
