...
class NoteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/notes')->with('message', 'Abonnement Succesvol Toegevoegd');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/notes')->with('message', 'Abonnement Succesvol Geupdate');
    }

    public function destroy($id)
    {
        Note::findOrFail($id)->delete();
        return back()->with('message', 'Abonnement Succesvol Verwijdert');
    }
}
